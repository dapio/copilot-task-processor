...
// Temporary mock - WorkflowOrchestrator moved to backup
class WorkflowOrchestrator {
  constructor(prisma: any) {}
  async executeWorkflow(...args: any[]) {
    throw new Error('WorkflowOrchestrator temporarily disabled');
  }
  async getExecutionStatus(...args: any[]) {
    throw new Error('WorkflowOrchestrator temporarily disabled');
  }
  async cancelWorkflow(...args: any[]) {
    throw new Error('WorkflowOrchestrator temporarily disabled');
  }
}
import { z } from 'zod';
